...
main :: proc() {
	...
	snake[1] = start_head_position - {1, 0}
	snake[2] = start_head_position - {2, 0}
	...
	for !rl.WindowShouldClose() {
		...
		for i in 0 ..< snake_length {
			current_rect := rl.Rectangle{f32(snake[i].x), f32(snake[i].y), CELL_SIZE, CELL_SIZE}
			rl.DrawRectangle(current_rect, {0, 255, 0, 255})
		}
