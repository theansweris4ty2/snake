...
main :: proc(){
    ...
    for !rl.WindowShouldClose(){
        ...
        tail_rect := rl.Rectangle{f32(snake_head_position.x) + f32(tail_position.x)*(CELL_SIZE)+1,f32( snake_head_position.y)+f32(tail_position.y)*CELL_SIZE, CELL_SIZE, CELL_SIZE}
