...
main :: proc(){
    ...
    for !rl.WindowShouldClose(){
        ...
        tail_rect := rl.Rectangle{f32(snake_head_position.x + tail_position)*(CELL_SIZE)+1,f32( snake_head_position.y)*CELL_SIZE + (tail_position*CELL_SIZE), CELL_SIZE, CELL_SIZE}
